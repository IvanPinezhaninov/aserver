...
class Receiver final : public aserver::receiver<local::stream_protocol> {
public:
  void operator()(net::io_context& ioc, local::stream_protocol::socket socket, net::cancellation_slot slot,
